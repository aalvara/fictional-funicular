...
#     sol_vec = [sol_vec; 1e6*Fmin, inf, 0, 0]
#     subplot(3,1,1)
#     hold on
#
#     plot(sol_vec(:,1),sol_vec(:,2),'LineWidth',3)
#     xlabel('Load Force [\muN]')
#     ylabel('Pull In Time [\mus]')
#     set(gca,'FontSize',12)
#     subplot(3,1,2)
#     hold on
#
#     plot(sol_vec(:,3),sol_vec(:,1),'LineWidth',3)
#     xlabel('Average Velocity [m/s]')
#     ylabel('Load Force [\muN]')
#     set(gca,'FontSize',12)
#     subplot(3,1,3)
#     hold on
#
#     plot(sol_vec(:,3),sol_vec(:,4),'LineWidth',3)
#     xlabel('Average Velocity [m/s]')
#     ylabel('Average Power [\muW]')
#     set(gca,'FontSize',12)
#
# subplot(3,1,1);
# legend('V=40V','V=50V','V=60V','V=70V','V=80V','V=90V','V=100V','V=110V')
